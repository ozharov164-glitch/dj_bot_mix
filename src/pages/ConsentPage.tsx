    ...
    <main className="page">
      <header className="hero">
        ...
        <p className="lead">
          ...
          Версия документов: {policyVersion}.
        </p>
      </header>
      ...
      <section className="panel">
        ...
        <p className="muted fine-print legal-note">
          Галочка в чекбоксе не снимает с вас ответственности за нарушение
          авторских прав. При жалобе правообладателя доступ к файлу может быть
          ограничен.
        </p>

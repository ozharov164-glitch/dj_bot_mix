  ...
  switch (status) {
    case "QUEUED": {
      ...
      return pos != null && pos > 0
        ? `Вы в очереди ≈ ${pos}. Можно закрыть приложение — напишем в чат.`
        : "Вы в очереди. Можно закрыть приложение — напишем в чат.";
    }
    case "RUNNING":
      return "Собираем файл. Обычно это занимает до нескольких минут.";
    case "COMPLETED":
